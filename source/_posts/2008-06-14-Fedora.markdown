...
En el caso de NVIDIA tuve que agregar las siguientes líneas a la sección "Files" ` ModulePath "/usr/lib/xorg/modules/extensions/nvidia" ModulePath "/usr/lib/xorg/modules"`
