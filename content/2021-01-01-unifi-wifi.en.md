...
<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
        <a href="https://i.imgur.com/gPGruVN.png" itemprop="contentUrl" data-size="1280x716">
            <img src="https://i.imgur.com/gPGruVNt.png" width="403" height="302" itemprop="thumbnail" alt="" />
        </a>
        <figcaption itemprop="caption description">Login screen</figcaption>
    </figure>

<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
        <a href="https://i.imgur.com/c7LDMAy.png" itemprop="contentUrl" data-size="1280x716">
            <img src="https://i.imgur.com/c7LDMAyt.png" width="403" height="302" itemprop="thumbnail" alt="" />
        </a>
        <figcaption itemprop="caption description">Dashboard</figcaption>
    </figure>
<figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
        <a href="https://i.imgur.com/tgBgeU9.png" itemprop="contentUrl" data-size="1280x716">
            <img src="https://i.imgur.com/tgBgeU9t.png" width="403" height="302" itemprop="thumbnail" alt="" />
        </a>
        <figcaption itemprop="caption description">Devices view</figcaption>
    </figure>
    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
    ...
    <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
        <a href="https://i.imgur.com/5wpQ9vA.png" itemprop="contentUrl" data-size="1280x716">
            <img src="https://i.imgur.com/5wpQ9vAt.png" width="403" height="302" itemprop="thumbnail" alt="" />
        </a>
        <figcaption itemprop="caption description">Connections with clients</figcaption>
    </figure>
        <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
        <a href="https://i.imgur.com/tnjGtCH.png" itemprop="contentUrl" data-size="1280x716">
            <img src="https://i.imgur.com/tnjGtCHt.png" width="403" height="302" itemprop="thumbnail" alt="" />
        </a>
        <figcaption itemprop="caption description">Map overlay</figcaption>
       </figure>
        <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
        <a href="https://i.imgur.com/iHhiNwA.png" itemprop="contentUrl" data-size="1280x716">
            <img src="https://i.imgur.com/iHhiNwAt.png" width="403" height="302" itemprop="thumbnail" alt="" />
        </a>
        <figcaption itemprop="caption description">Traffic analysis</figcaption>
       </figure>
