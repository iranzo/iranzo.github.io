...
[Fedora](http://fedoraproject.org/) es una distribución [Linux]({% post_url 2004-03-18-Que-es-Linux %}) fruto del desarrollo de la extinta Red Hat Linux.
...
Puedes consultar información al respecto en [Kickstart: instalaciones automatizadas para anaconda]({% post_url 2008-05-11-Kickstart-instalaciones %})

**Security Enhanced Linux (SELinux)**

[SELinux](% post_url 2008-01-04-Security-Enhanced-Linux-SELinux %}) es un conjunto de módulos de seguridad para el kernel incorporados y activados por defecto en Fedora que confinan los programas en sus "compartimentos", impidiendo que realicen acciones que no deberían.
...
[Gestor de Volúmenes Lógicos (LVM)]({% post_url 2007-03-09-Gestor-de-Volumenes-Logicos-LVM %}) viene incorporado de serie y habilitado por defecto en Fedora desde hace ya muchas versiones, como novedad en la versión 9 es la inclusión de la posibilidad de utilizar volúmenes cifrados para todos los datos (hasta el momento se podía hacer con volúmenes que no fueran el de sistema, por ejemplo con /home), aumentando así la seguridad de los datos confidenciales que se llevan en dispositivos portátileso pc's de cara a posibles [pérdidas o robos](http://news.google.es/news?hl=es&ned=es&q=datos++port%C3%A1til+robado&btnG=Buscar).
...
{% img /imagen/Pantallazo-00.png 'Arranque DVD' %}
{% img /imagen/Pantallazo-01.png 'Arranque kernel' %}
{% img /imagen/Pantallazo-02.png 'Verificación disco' %}
{% img /imagen/Pantallazo-03.png 'Inicio instalador' %}
{% img /imagen/Pantallazo-04.png 'Selección idioma' %}
{% img /imagen/Pantallazo-05.png 'Selección teclado' %}
{% img /imagen/Pantallazo-06.png 'Inicialización disco' %}
{% img /imagen/Pantallazo-07.png 'Configuración red' %}
{% img /imagen/Pantallazo-08.png 'Zona horaria' %}
{% img /imagen/Pantallazo-09.png 'Password de root' %}
{% img /imagen/Pantallazo-10.png 'Clave sencilla' %}
{% img /imagen/Pantallazo-11.png 'Particionamiento' %}
{% img /imagen/Pantallazo-12.png 'Cifrado de discos' %}
{% img /imagen/Pantallazo-13.png 'Aplicar cambios en disco' %}
{% img /imagen/Pantallazo-14.png 'Formateo' %}
{% img /imagen/Pantallazo-15.png 'Preparación instalador' %}
{% img /imagen/Pantallazo-16.png 'Preparando paquetes' %}
{% img /imagen/Pantallazo-17.png 'Repositorios de software' %}
{% img /imagen/Pantallazo-18.png 'Verificando dependencias' %}
{% img /imagen/Pantallazo-19.png 'Empezando instalación' %}
{% img /imagen/Pantallazo-20.png 'Progreso instalación' %}
{% img /imagen/Pantallazo-21.png 'Acabando instalación' %}
{% img /imagen/Pantallazo-22.png 'Fin de instalación y reinicio' %}
{% img /imagen/Pantallazo-23.png 'Clave de cifrado de disco en arranque' %}
...
{% img /imagen/Pantallazo-24.png 'Login al entorno gráfico' %}
{% img /imagen/Pantallazo-25.png 'Informe y envío de errores' %}
{% img /imagen/Pantallazo-26.png 'Actualizaciones pendientes' %}
{% img /imagen/Pantallazo-27.png 'Acceso como root para actualizar' %}
{% img /imagen/Pantallazo-28.png 'PackageKit realizando las tareas de actualización' %}
{% img /imagen/Pantallazo-29.png 'Actualización completada' %}
{% img /imagen/Pantallazo-30.png 'Contraseña del protector de pantalla con posibilidad de dejar notas' %}
